class TeamZ::Profile < ActiveRecord::Base
  ...
  def twitch_tv_embed_object
    ...
    %{<iframe frameborder="0" scrolling="no" id="chat_embed" src="http://twitch.tv/chat/embed?channel=#{self.twitch_tv_username}&amp;popout_chat=true" height="500" width="350"></iframe>}    
  end
end